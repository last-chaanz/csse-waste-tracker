...
describe('UpdateUserModal', () => {
    ...
    it('calls onClose when the cancel button is clicked', () => {
        const { getByText } = render(<UpdateUserModal isOpen={true} user={user} onClose={onClose} onUpdate={onUpdate} />);
    ...
    it('does not render when isOpen is false', () => {
        const { queryByText } = render(<UpdateUserModal isOpen={false} user={user} onClose={onClose} onUpdate={onUpdate} />);
